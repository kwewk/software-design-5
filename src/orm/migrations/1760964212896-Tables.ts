...
export class Tables1760964212896 implements MigrationInterface {
  name = 'Tables1760964212896';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
            ALTER TABLE "Rating"
            ADD CONSTRAINT "FK_2653c14493d22bae67e5ce15f4b" FOREIGN KEY ("recipe_id") REFERENCES "Recipe"("ID") ON DELETE CASCADE ON UPDATE CASCADE
        `);
    await queryRunner.query(`
            ALTER TABLE "Rating"
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
        ...
        `);
    await queryRunner.query(`
            ALTER TABLE "Rating" DROP CONSTRAINT "FK_2653c14493d22bae67e5ce15f4b"
        `);
    await queryRunner.query(`
